...
func _on_lead_timer_timeout() -> void:
	...
	Ge.play_audio_from_string_array(enemy.audio_emitter, -10, "res://Assets/SFX/Goblin/Chatter/")
...
func _on_secondary_timer_timeout() -> void:
	...
	Ge.play_audio_from_string_array(friend.audio_emitter, -10, "res://Assets/SFX/Goblin/Chatter/")
	lead_timer.start()
