...
func _calculate_camera_position(delta):
	...
	if reg_trans:
		if _transition_progress < reg_trans.transition_time && _last_region:
			...
			camera.global_position = _current_region.get_camera_position(Vector2(target_node.position.x, target_node.position.y-30))
			camera.zoom = _current_region.camera_zoom
			camera.rotation = _current_region.camera_rotation
			return
		...
		camera.global_position = _current_region.get_camera_position(Vector2(target_node.position.x, target_node.position.y-60))
		camera.zoom = _current_region.camera_zoom
		camera.rotation = _current_region.camera_rotation
